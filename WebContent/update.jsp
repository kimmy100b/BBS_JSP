					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" name="bbsTitle"
								placeholder="제목을 입력하세요"  maxlength="50" value="<%=bbs.getBbsTitle()%>"%>
						</tr>
						<tr>
							<td><textarea type="text" class="form-control"
									placeholder="내용을 입력하세요"  name="bbsContent" maxlength="2048" style="height: 350px;"><%=bbs.getBbsContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
